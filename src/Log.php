...
class Log
{
    ...
    private static function validate($arguments_array)
    {
        $validator = Validator::make($arguments_array, [
            ...
            'parent_type' => 'nullable|string|required_with:parent_id',
            ...
            'record_id' => 'nullable|uuid|required_with:record_type',
            'record_type' => 'nullable|string|required_with:record_id',
